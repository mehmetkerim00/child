...
/// Вид задачи диспетчеру.
enum DispatcherTaskKind implements _i1.SerializableModel {
  rideNotConfirmed,
  driverNotDeparted,
  ...
  static DispatcherTaskKind fromJson(String name) {
    switch (name) {
      case 'rideNotConfirmed':
        return DispatcherTaskKind.rideNotConfirmed;
      case 'driverNotDeparted':
        return DispatcherTaskKind.driverNotDeparted;
      case 'notificationUndelivered':
