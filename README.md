...
- Языки интерфейса: русский, туркменский, английский. Строки — в
  `packages/core_l10n/lib/l10n/app_{ru,tk,en}.arb`; полноту всех трёх
  проверяет `packages/core_l10n/test/arb_completeness_test.dart`, и CI
  падает на забытом ключе или пустом переводе.
