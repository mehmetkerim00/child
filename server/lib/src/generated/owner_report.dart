...
import 'package:child_server/src/generated/protocol.dart' as _i5;

/// Отчёт владельцу за период.
abstract class OwnerReport
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'drivers': drivers.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'routes': routes.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'familyBalanceTenge': familyBalanceTenge,
      'familiesInDebt': familiesInDebt,
      'revenueTenge': revenueTenge,
      'smsCostTenge': smsCostTenge,
