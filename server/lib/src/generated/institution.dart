...
class InstitutionUpdateTable extends _i1.UpdateTable<InstitutionTable> {
  ...
  _i1.ColumnValue<_i2.InstitutionType, _i2.InstitutionType> type(
    _i2.InstitutionType value,
  ) => _i1.ColumnValue(
    table.type,
    value,
  );
  ...
  _i1.ColumnValue<String, String> handoverCode(String value) => _i1.ColumnValue(
    table.handoverCode,
    value,
  );
...
class InstitutionTable extends _i1.Table<int?> {
  ...
  late final _i1.ColumnEnum<_i2.InstitutionType> type;
  ...
  /// Код учреждения для подтверждения передачи ребёнка.
  late final _i1.ColumnString handoverCode;
